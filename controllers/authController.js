...
exports.restrictTo = (...roles) => {
  return (req, res, next) => {
    // roles ['member', 'owner']. role='member'
...
exports.checkOwner = exports.forgotPassword = catchAsync(
  async (req, res, next) => {
    ...
    const message = `Forgot your password? Submit a PATCH request to reset your password and confirm your password to: ${resetURL}.\nIf you didn't forgot your password, please ignore this email.`;
    try {
      await sendEmail({
        email: user.email,
...
exports.updatePassword = catchAsync(async (req, res, next) => {
  ...
  // update the password, log in user
  user.password = req.body.password;
  user.passwordConfirm = req.body.passwordConfirm;
  await user.save();
